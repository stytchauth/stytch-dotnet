...
namespace Stytch.net.Clients.B2B
{
    public class SCIMConnection
    {
        ...
        )
        {
            ...
            {
                Path = $"/v1/b2b/scim/{Uri.EscapeDataString(request.OrganizationId)}/connection/{Uri.EscapeDataString(request.ConnectionId)}"
            };
        ...
        )
        {
            ...
            var uriBuilder = new UriBuilder(_httpClient.BaseAddress)
            {
                Path = $"/v1/b2b/scim/{Uri.EscapeDataString(request.OrganizationId)}/connection/{Uri.EscapeDataString(request.ConnectionId)}/rotate/start"
            };
        ...
        )
        {
            ...
            var uriBuilder = new UriBuilder(_httpClient.BaseAddress)
            {
                Path = $"/v1/b2b/scim/{Uri.EscapeDataString(request.OrganizationId)}/connection/{Uri.EscapeDataString(request.ConnectionId)}/rotate/complete"
            };
        ...
        )
        {
            ...
            var uriBuilder = new UriBuilder(_httpClient.BaseAddress)
            {
                Path = $"/v1/b2b/scim/{Uri.EscapeDataString(request.OrganizationId)}/connection/{Uri.EscapeDataString(request.ConnectionId)}/rotate/cancel"
            };
        ...
        )
        {
            ...
            var uriBuilder = new UriBuilder(_httpClient.BaseAddress)
            {
                Path = $"/v1/b2b/scim/{Uri.EscapeDataString(request.OrganizationId)}/connection"
            };

...
namespace Stytch.net.Clients.B2B
{
    public class SSOExternal
    {
        ...
        )
        {
            ...
            {
                Path = $"/v1/b2b/sso/external/{Uri.EscapeDataString(request.OrganizationId)}"
            };
        ...
        )
        {
            ...
            var uriBuilder = new UriBuilder(_httpClient.BaseAddress)
            {
                Path = $"/v1/b2b/sso/external/{Uri.EscapeDataString(request.OrganizationId)}/connections/{Uri.EscapeDataString(request.ConnectionId)}"
            };

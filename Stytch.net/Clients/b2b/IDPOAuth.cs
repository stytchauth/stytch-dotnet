...
namespace Stytch.net.Clients.B2B
{
    public class IDPOAuth
    {
        ...
        /// </summary>
        public async Task<B2BIDPOAuthAuthorizeStartResponse> AuthorizeStart(
            B2BIDPOAuthAuthorizeStartRequest request
        )
        {
            ...
            {
                return JsonConvert.DeserializeObject<B2BIDPOAuthAuthorizeStartResponse>(responseBody);
            }
            try
            {
        ...
        /// [Exchange Access Token](https://stytch.com/docs/b2b/api/connected-app-access-token-exchange) flow.
        /// </summary>
        public async Task<B2BIDPOAuthAuthorizeResponse> Authorize(
            B2BIDPOAuthAuthorizeRequest request
        )
        {
            var method = HttpMethod.Post;
            var uriBuilder = new UriBuilder(_httpClient.BaseAddress)
            ...
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<B2BIDPOAuthAuthorizeResponse>(responseBody);
            }
            try
            {
                var apiException = JsonConvert.DeserializeObject<StytchApiException>(responseBody);

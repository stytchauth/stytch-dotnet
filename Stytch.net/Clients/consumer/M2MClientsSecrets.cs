...
namespace Stytch.net.Clients.Consumer
{
    public class M2MClientsSecrets
    {
            ...
            M2MClientsSecretsRotateStartRequest request)
        {
            ...
            var uriBuilder = new UriBuilder($"/v1/m2m/clients/${request.ClientId}/secrets/rotate/start");
        ...
        {
            var method = HttpMethod.Post;
            var uriBuilder = new UriBuilder($"/v1/m2m/clients/${request.ClientId}/secrets/rotate/cancel");
        ...
        {
            var method = HttpMethod.Post;
            var uriBuilder = new UriBuilder($"/v1/m2m/clients/${request.ClientId}/secrets/rotate");

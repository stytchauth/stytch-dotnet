...
using M2M = Stytch.net.Clients.b2c.M2M;
using Project = Stytch.net.Clients.b2c.Project;
...
// ADDIMPORT: using M2M = Stytch.net.Clients.b2c.M2M;
// ADDIMPORT: using Project = Stytch.net.Clients.b2c.Project;

...
namespace Stytch.net.Models.Consumer
{
    ...
    public class B2BOTPSmsAuthenticateRequest
    {
        ...
        public B2BOTPSmsAuthenticateRequest(string organizationId, string memberId, string code)
        {
    ...
    public class B2BOTPSmsSendRequest
    {
        ...
        [JsonProperty("session_jwt")]
        public string SessionJwt { get; set; }
        public B2BOTPSmsSendRequest(string organizationId, string memberId)
        {
            this.OrganizationId = organizationId;
            this.MemberId = memberId;
        }
